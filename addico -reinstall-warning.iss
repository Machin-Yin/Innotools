...
Source: "C:\Users\TEST\Desktop\AdbeRdr.exe"; DestDir: "{app}"; Flags: ignoreversion  deleteafterinstall
...
[Run]
Filename: "{app}\AdbeRdr.exe"; Description: "Setup"; Flags: skipifsilent shellexec
   ...
   begin
    ...
    while IsAppRunning do
     ...
     begin   
        ...
        begin   
          KeynotExist:= false; 
         // MsgBox('安装程序检测到“一铭云打印”已经安装！' #13#13 '您必须先卸载它,然后单击“确定”继续安装，否则按“取消”退出！', mbConfirmation, MB_OKCANCEL);  
